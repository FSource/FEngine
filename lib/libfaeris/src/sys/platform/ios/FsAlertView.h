...
typedef void (^FsAlertViewBlock)();

typedef void (^FsAlertViewStringBlock)(NSString*);

@interface FsAlertView : NSObject <UIAlertViewDelegate>
...
- (id) initWithTitle:(NSString *)title
   ...
   cancelButtonBlock:(FsAlertViewBlock)cancelButtonBlock
    otherButtonBlock:(FsAlertViewBlock)otherButtonBlock;
