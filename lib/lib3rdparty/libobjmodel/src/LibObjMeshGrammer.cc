...
#define yyparse         libobjmesh_parse
#define yylex           libobjmesh_lex
#define yyerror         libobjmesh_error
#define yydebug         libobjmesh_debug
#define yynerrs         libobjmesh_nerrs


/* Copy the first part of user declarations.  */
#line 1 "meshgrammer.y" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "LibObjMeshGrammer.h".  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined LIBOBJMESH_STYPE_IS_TRIVIAL && LIBOBJMESH_STYPE_IS_TRIVIAL)))
...
#if LIBOBJMESH_DEBUG || YYERROR_VERBOSE || 1
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "ERR", "EOL", "DECIMAL", "INTEGER",
  "WORD", "MATERIALLIB_MARKER", "MTLFILEPATH", "USEMATERIAL_MARKER",
  "NULL_MARKER", "VERTEX_MARKER", "TEXEL_MARKER", "NORMAL_MARKER",
  "LINE_MARKER", "FACE_MARKER", "GROUP_MARKER", "OBJECT_MARKER",
  "SMOOTHINGGROUP_MARKER", "CAMERA_MARKER", "OFF_WORD", "'/'", "$accept",
  "objfile", "obj_line", "camera", "vertex", "value", "std_string",
  "object", "group", "groupnamelist", "groupname", "texel", "normal",
  "line", "linedescrlist", "pair", "face", "vertexdescrlist", "tripple",
  "materiallib", "usematerial", "smoothinggroup", "groupid", YY_NULLPTR
};
#endif
...
{
      -8,     2,    -8,    -8,    -6,    -3,    25,    25,    25,    -8,
      -8,    26,    26,     3,    25,     1,    -8,    -8,    -8,    -8,
      -8,    -8,    -8,    -8,    -8,    -8,    -8,    -8,    -8,    -8,
      -8,    -8,    25,    25,    25,     5,    17,    -8,    -8,    -8,
      26,    -8,    -8,    -8,    -8,    -8,    25,    -8,    25,    -8,
      25,     6,    -8,    12,    -8,    -8,    25,    25,    -8,    29,
       7,    -8,    -8,    -8,    14,    31,    32,    -8,    -8
};
...
{
      -1,     1,    15,    16,    17,    32,    39,    18,    19,    40,
      41,    20,    21,    22,    35,    52,    23,    36,    54,    24,
      25,    26,    45
};
...
{
      33,    34,     2,    27,    28,    47,     3,    46,    29,    43,
       4,    51,     5,    64,     6,     7,     8,     9,    10,    11,
      12,    13,    14,    53,    44,    48,    49,    50,    59,    65,
      30,    31,    37,    38,    60,    63,    66,    67,    68,    56,
      42,    57,     0,    58,    55,     0,     0,     0,     0,    61,
      62
};

static const yytype_int8 yycheck[] =
{
       7,     8,     0,     9,     7,     4,     4,    14,    11,     6,
       8,     6,    10,     6,    12,    13,    14,    15,    16,    17,
      18,    19,    20,     6,    21,    32,    33,    34,    22,    22,
       5,     6,     6,     7,    22,     6,    22,     6,     6,    46,
      12,    48,    -1,    50,    40,    -1,    -1,    -1,    -1,    56,
      57
};
...
{
       0,    24,     0,     4,     8,    10,    12,    13,    14,    15,
      16,    17,    18,    19,    20,    25,    26,    27,    30,    31,
      34,    35,    36,    39,    42,    43,    44,     9,     7,    11,
       5,     6,    28,    28,    28,    37,    40,     6,     7,    29,
      32,    33,    29,     6,    21,    45,    28,     4,    28,    28,
      28,     6,    38,     6,    41,    33,    28,    28,    28,    22,
      22,    28,    28,     6,     6,    22,    22,     6,     6
};
...
int yydebug;
#else /* !LIBOBJMESH_DEBUG */
# define YYDPRINTF(Args)
# define YY_SYMBOL_PRINT(Title, Type, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !LIBOBJMESH_DEBUG */
